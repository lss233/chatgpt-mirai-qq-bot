...
# Define test blocks
input_block = Block(name="InputBlock", inputs={}, outputs={"output1": Output(name="output1", label="输出1", data_type=str, description="Input data")})
bad_block = Block(name="InputBlock", inputs={}, outputs={"output1": Output(name="output1", label="输出1", data_type=int, description="Input data")})
process_block = Block(name="ProcessBlock", inputs={"input1": Input(name="input1", label="输入1", data_type=str, description="Input data")},

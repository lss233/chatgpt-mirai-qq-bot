...
4. 找到 Console （或控制台），在一个蓝色的 `>` 后面输入：`document.cookie` 并回车
5. 复制下一行出现的内容，他们就是你的 Cookie  
...
wss_link = "wss://sydney.bing.com/sydney/ChatHub"
# 会话创建的接入点，在国内的用户可以修改成下面这个
bing_endpoint = "https://edge.churchless.tech/edgesvc/turing/conversation/create"
```

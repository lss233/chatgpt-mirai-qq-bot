...
from llama_index.indices.common.tree.base import GPTTreeIndexBuilder
...
from llama_index.indices.query.tree.summarize_query import GPTTreeIndexSummarizeQuery
